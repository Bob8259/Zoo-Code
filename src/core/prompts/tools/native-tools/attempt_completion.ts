...
REQUIRED: When you have completed the user's task, you MUST call this tool. Do NOT end the task with a plain-text summary — always use attempt_completion instead.
