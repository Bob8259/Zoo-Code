...
const SUBTASK_GUIDELINE_5 =
	"5. You are a delegated subtask. Complete the assigned work directly with your available tools. Do not call `new_task`. When done, call `task_completion` with a concise summary for the parent."
